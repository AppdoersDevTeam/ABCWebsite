          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <ScrollReveal direction="up" delay={200}>
              <p className="text-[1.5625rem] leading-6 text-white text-center max-w-5xl mx-auto mb-6 transition-all duration-1000 delay-300">
                {member.description ? (
                  <span className="block whitespace-normal font-raleway font-normal text-center">
                  ...
                  <>
                    <span className="block whitespace-nowrap font-raleway font-normal text-center">Leading with passion</span>
                    <span className="block whitespace-nowrap mt-[12px] font-raleway font-normal text-center">and a heart for service.</span>
                  </>
                )}
              </p>
            </ScrollReveal>
