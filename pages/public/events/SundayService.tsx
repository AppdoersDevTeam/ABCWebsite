          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <ScrollReveal direction="up" delay={200}>
              <p className="text-base sm:text-lg md:text-[1.375rem] lg:text-[1.5625rem] leading-relaxed text-white text-center max-w-5xl mx-auto mb-6 transition-all duration-1000 delay-300 px-2 sm:px-0">
                <span className="block font-raleway font-normal text-center">Join Us for Worship.</span>
                <span className="block mt-3 sm:mt-4 font-raleway font-normal text-center">Every Sunday at 10:00 AM</span>
                <span className="block mt-3 sm:mt-4 font-raleway font-normal text-center">Join us for worship, teaching, and community.</span>
              </p>
            </ScrollReveal>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-24">
                <Link to="/events" className="group">
                  <GlowingButton variant="outline" size="md" className="!px-6 !py-[14px] !border-gold !bg-gold/20 !text-white hover:!bg-gold hover:!text-white !rounded-full transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:scale-110 hover:!border-gold active:scale-95 hover:-translate-y-1 !normal-case">
                    ...
                    <span className="text-white font-normal text-base leading-6 transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] group-hover:font-semibold group-hover:tracking-wider">Back to What's On</span>
                  </GlowingButton>
                </Link>
              </div>
            </ScrollReveal>
